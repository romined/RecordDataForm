			...
			<td>
				<table border="0" cellspacing="0" width="100%">
					...
					<tr>
						...
						<td width="400px" valign="top" class="ms-formbody">
							<SharePoint:FormField runat="server" id="FormField2" ControlMode="New" FieldName="SpecNum" __designer:bind="{ddwrt:DataBind('i',concat('ff21',$Pos),'Value','ValueChanged','ID',ddwrt:EscapeDelims(string(@ID)),'@SpecNum')}"/>
							<SharePoint:FieldDescription runat="server" id="FieldDescription2" FieldName="SpecNum" ControlMode="New"/>
						</td>
					</tr>
					<tr>
						<td width="190px" valign="top" class="ms-formlabel">
						...
						<td width="400px" valign="top" class="ms-formbody">
							<SharePoint:FormField runat="server" id="FormField3" ControlMode="New" FieldName="DrawingNum" __designer:bind="{ddwrt:DataBind('i',concat('ff22',$Pos),'Value','ValueChanged','ID',ddwrt:EscapeDelims(string(@ID)),'@DrawingNum')}"/>
							<SharePoint:FieldDescription runat="server" id="FieldDescription3" FieldName="DrawingNum" ControlMode="New"/>
						</td>
					</tr>
					<tr>
						<td width="190px" valign="top" class="ms-formlabel">
						...
						<td width="400px" valign="top" class="ms-formbody">
							<SharePoint:FormField runat="server" id="FormField4" ControlMode="New" FieldName="DetailDescription" __designer:bind="{ddwrt:DataBind('i',concat('ff23',$Pos),'Value','ValueChanged','ID',ddwrt:EscapeDelims(string(@ID)),'@DetailDescription')}"/>
							<SharePoint:FieldDescription runat="server" id="FieldDescription4" FieldName="DetailDescription" ControlMode="New"/>
						</td>
					</tr>
					<tr>
						<td width="190px" valign="top" class="ms-formlabel">
						...
						<td width="400px" valign="top" class="ms-formbody">
							<SharePoint:FormField runat="server" id="FormField5" ControlMode="New" FieldName="Submitter_Comments" __designer:bind="{ddwrt:DataBind('i',concat('ff4',$Pos),'Value','ValueChanged','ID',ddwrt:EscapeDelims(string(@ID)),'@Submitter_Comments')}"/>
							<SharePoint:FieldDescription runat="server" id="FieldDescription5" FieldName="Submitter_Comments" ControlMode="New"/>
						</td>
					</tr>
					<tr>
						<td width="190px" valign="top" class="ms-formlabel">
						...
						<td width="400px" valign="top" class="ms-formbody">
							<SharePoint:FormField runat="server" id="FormField6" ControlMode="New" FieldName="Contractor_Cert" __designer:bind="{ddwrt:DataBind('i',concat('ff19',$Pos),'Value','ValueChanged','ID',ddwrt:EscapeDelims(string(@ID)),'@Contractor_Cert')}"/>
							<SharePoint:FieldDescription runat="server" id="FieldDescription6" FieldName="Contractor_Cert" ControlMode="New"/>
						</td>
					</tr>																																																												
			    ...
			    <tr>
						...
						<td width="400px" valign="top" class="ms-formbody">
							<SharePoint:FormField runat="server" id="FormField7" ControlMode="New" FieldName="RD_Signature" __designer:bind="{ddwrt:DataBind('i',concat('ff20',$Pos),'Value','ValueChanged','ID',ddwrt:EscapeDelims(string(@ID)),'@RD_Signature')}"/>
							<SharePoint:FieldDescription runat="server" id="FieldDescription7" FieldName="RD_Signature" ControlMode="New"/>
						</td>
					</tr>
				</table>
			    <table>
